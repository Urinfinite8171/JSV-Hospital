...
const Home = () => {
  ...
  const images = [
    "../src/assets/Photos/hospital/bg.jpeg",
    "../src/assets/Photos/hospital/hospitalBed.jpeg",
    "../src/assets/Photos/hospital/hospital-bg.jpg",
    "../src/assets/Photos/hospital/hospital-bg1.jpg",
    "../src/assets/Photos/hospital/hospital-bg2.jpg",
    "../src/assets/Photos/hospital/laboratory.jpg",
  ];
  ...
  return (
    <>
        ...
        <div className="flex flex-wrap justify-center ">
          <div className=" flex flex-col  bg-slate-300 rounded-2xl shadow-md w-full m-3  sm:w-96 max-sm:w-96">
            <img
              ...
              src="../src/assets/Photos/hospital/ot-picture.jpg"
              alt="OT"
            ></img>
          ...
          <div className=" flex flex-col  bg-slate-300 rounded-2xl shadow-md w-full m-3  sm:w-96 max-sm:w-96 ">
            <img
              className="h-52 m-3 rounded-2xl shadow-xl cursor-pointer"
              src="../src/assets/Photos/hospital/icu-patientjpg.jpg"
              alt="OT"
            ></img>
            <h6 className="text-xl text-center mb-2 font-medium ">
          ...
          <div className=" flex flex-col  bg-slate-300 rounded-2xl shadow-md w-full m-3  sm:w-96 max-sm:w-96 ">
            <img
              className="h-52 m-3 rounded-2xl shadow-xl cursor-pointer"
              src="../src/assets/Photos/hospital/pharmacist.jpg"
              alt="OT"
            ></img>
            <h6 className="text-xl text-center mb-2 font-medium ">
          ...
          <div className=" flex flex-col  bg-slate-300 rounded-2xl shadow-md w-full m-3  sm:w-96 max-sm:w-96">
            <img
              className="h-52 m-3 rounded-2xl shadow-xl cursor-pointer"
              src="../src/assets/Photos/hospital/hospitalBed.jpeg"
              alt="OT"
            ></img>
            <h6 className="text-xl text-center mb-2 font-medium ">
      ...
      <div>
        ...
        <div className="bg-[url('../src/assets/Photos/hospital/hospital-bg1.jpg')] bg-cover bg-center bg-no-repeat container mx-auto flex items-center justify-center rounded-3xl p-4 md:p-8">
          <div className="bg-white bg-opacity-75 p-4 md:p-8 rounded-3xl shadow-lg w-full max-w-7xl">
            ...
            <div className="flex flex-wrap justify-center mt-4">
              {[
                ...
                >
                  <img
                    src={`../src/assets/Photos/hospital/${dept.src}`}
                    alt={dept.alt}
            ...
            <div>
              ...
              <div className="flex flex-col md:flex-row bg-slate-300 rounded-2xl shadow-md w-full mt-4">
                <img
                  src="../src/assets/Photos/hospital/diagnosis.jpg"
                  alt="diagnosis"
            ...
            <div>
              ...
              <div className="flex flex-col md:flex-row bg-slate-300 rounded-2xl shadow-md w-full mt-4">
                <img
                  src="../src/assets/Photos/hospital/surgical.jpg"
                  alt="surgical"
                  className="w-full md:w-1/2 rounded-2xl object-cover"
                />
                <p className="text-lg md:text-xl m-4 p-2">
            ...
            <div>
              ...
              <div className="flex flex-col md:flex-row bg-slate-300 rounded-2xl shadow-md w-full mt-4">
                <img
                  src="../src/assets/Photos/hospital/Emergency.jpg"
                  alt="Emergency"
                  className="w-full md:w-1/2 rounded-2xl object-cover"
                />
                <p className="text-lg md:text-xl m-4 p-2">
      ...
      <div className="container mx-auto p-4 mt-3">
        ...
        <div className="flex bg-slate-300 rounded-2xl shadow-md w-full m-3  max-sm:flex-col">
          <img
            src="../src/assets/Photos/hospital/medical-camp.jpg"
            alt="medical-camp"
